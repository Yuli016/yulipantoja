    ...
    ?>
      ...
      <nav id="navbar" class="">
        <div class="nav-wrapper">
          <div class="logo">
            <a href="index.html"> <i class="fas fa-cat"></i> Yuli</a>
          </div>
      ...
      <div class="center-div">
        ...
        <div class="contact-form-wrapper d-flex justify-content-center">
          ...
          <form class="contact-form">
            ...
            <p class="contact">Thank you for contacting me. I'll get back to you as soon as soon as possible!</p><br><br>
          </form>
        </div>
          ...
          <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3s">
              ...
              <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4s">
                <!-- Content -->
                <h2 class="footer-title"><i class="fas fa-cat"></i> Yuli Pantoja</h2>
                <p class="contact"></p>
              </div>
              <!-- Grid column -->
              ...
              <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4s">
                ...
                <p class="contact"><i class="fas fa-phone"></i> (831) 755-8856</p>
              </div>
              <!-- Grid column -->
            </div>
            <!-- Grid row -->
